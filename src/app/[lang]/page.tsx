...
export default function Home() {
  ...
  return (
    <div className="space-y-0">
      <section className="relative flex items-center justify-center min-h-screen lg:min-h-[70vh] text-center text-white">
        <Image 
              ...
              <Accordion type="single" collapsible className="w-full space-y-4">
                  {faqs.map((faq, index) => (
                      <motion.div 
                        ...
                        transition={{ delay: index * 0.1 }}
                      >
                          <AccordionItem value={`item-${index}`} className="bg-card border border-border rounded-2xl px-6">
